...
definitions = {'definitions': {'Pet': {'type': 'object', 'properties': {'id': {'type': 'integer', 'format': 'int64'}, 'name': {'type': 'string', 'example': 'doggie'}, 'status': {'type': 'string', 'description': 'pet status in the store', 'enum': ['available', 'pending', 'sold']}}}}, 'parameters': {}}
...
filters = {
    ('pet', 'POST'): {201: {'headers': None, 'schema': None}, 405: {'headers': None, 'schema': None}},
    ('pet', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Pet'}}}, 404: {'headers': None, 'schema': None}},
}

...
validators = {
    ('weather', 'GET'): {'args': {'required': ['expression'], 'properties': {'expression': {'description': 'user sentence e.g. who is the weather in Sydney', 'type': 'string'}}}},
}

filters = {
    ('weather', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string'}}}}},
}
